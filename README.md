...
- **Narrow MCP surface** — 21 audited tools (`box_request_vm`, `box_request_installer`, `box_exec`, `box_screenshot`, `box_delete_vm`, …). No raw shell, no libvirt passthrough, no XML.
